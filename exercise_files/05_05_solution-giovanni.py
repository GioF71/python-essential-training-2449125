...
class TerminalScribe:
    ...
    def up(self):
        #self.direction = [0, -1]
        #self.direction = self.calcDirection(0)
        # self.forward_ryan(1)
        self.forward(1, 0)
    ...
    def bounce(self, pos):
        ...
        self.direction = [self.direction[0] * reflection[0],
                          self.direction[1] * reflection[1]]

    def forward(self, distance, degrees):
    ...
    def forward_ryan(self, distance):
        for i in range(distance):
...
scribe.forward_ryan(100)
#scribe.forward(100, 150)
